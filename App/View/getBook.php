...
<div class="content">
    ...
    <!-- BACK TO BOOKCASE -->
    <div class="links"><a href="index.php?action=listBooks">Bibliothèque</a> <span class="red"><i class=" fas
                    fa-chevron-right"></i><i class="fas fa-chevron-right"></i></span> <?= htmlspecialchars($book['title_book']) ?></div>
